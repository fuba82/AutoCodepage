...
:: Date:   18.04.2017
::
:: This file is part of the build system of the AutoCodepage plugin for
:: Notepad++.
::
...
:Step1
copy "..\doc\AutoCodepage.txt" "..\_npp\Win32\plugins\doc" > NUL
copy "..\doc\AutoCodepage.txt" "..\_npp\Win64\plugins\doc" > NUL


:Step2
if /i "%Config%" neq "Release" goto :Step3

call "..\deploy\Deploy.cmd" "AutoCodepage" "%Platform%"
